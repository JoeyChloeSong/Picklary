...
(function () {
  ...
  function render() {
    ...
    targetBtns.forEach(function (b) { b.classList.toggle("is-selected", a.zone === b.getAttribute("data-val")); });
  ...
  shotBtns.forEach(function (b) { b.addEventListener("click", function () {
    ...
    shotBtns.forEach(function (x) { x.classList.toggle("is-selected", x === b); });
  ...
  powerBtns.forEach(function (b) { b.addEventListener("click", function () {
    ...
    powerBtns.forEach(function (x) { x.classList.toggle("is-selected", x === b); });
    syncAnswerSteps(); updateNext();
  }); });
  function selectZoneValue(key) {
    ...
    targetBtns.forEach(function (x) { x.classList.toggle("is-selected", x.getAttribute("data-val") === key); });
  ...
  playerBtns.forEach(function (b) { b.addEventListener("click", function () { answers[pos].player = b.getAttribute("data-val"); playerBtns.forEach(function (x) { x.classList.toggle("is-selected", x === b); }); drawScene(served[pos]); syncAnswerSteps(); updateNext(); }); });
