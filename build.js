  ...
  <div class="quiz" data-dupr-quiz>
    ...
    <div class="quiz__layout">
      <div class="quiz__court">
        ${courtSvg}
        <ul class="court-legend"><li><span class="dot dot--me"></span>${esc(labels.me)}</li><li><span class="dot dot--you"></span>${esc(labels.partner)}</li><li><span class="dot dot--opp"></span>${esc(labels.opp)}</li><li><span class="dot dot--ball"></span>${esc(labels.incoming)}</li></ul>
      </div>
