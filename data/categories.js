  ...
  return [
    ...
    },
    {
      ...
      translations: {
        ko: {
          name: '규칙·입문',
          blurb: '점수 계산, 서브, 키친, 포지셔닝, 코트 매너.',
          intro:
            '피클볼 입문 초기의 혼란 대부분은 몇 가지 규칙에서 옵니다. 서브, 투바운스 규칙, 그리고 논발리존(키친)입니다. 이 글들은 초보자가 실제로 헷갈리는 규칙과 함께, 오픈플레이에서 통하는 암묵적 매너까지 설명해 첫 경기를 한결 수월하게 만듭니다.'
        },
        es: {
    ...
    },
    {
      ...
      translations: {
        ko: {
          name: '대회·리그',
          blurb: '대회 진행 방식, DUPR 설명, 경쟁 무대 개요.',
          intro:
            '오픈플레이을 넘어 도전할 준비가 되셨나요? 이 글들은 대회 구조(포맷·브래킷·디비전), DUPR이 무엇이고 어떻게 쓰는지, 리그와 투어가 어떻게 맞물리는지를 다룹니다. 내부자가 아니라 첫 대회를 앞둔 사람을 위한 설명입니다.'
        },
        es: {
    ...
    },
    {
      ...
      translations: {
        ko: {
          ...
          intro:
            '피클볼의 프로·국제 무대는 빠르게 바뀝니다. 매주 달라지는 순위를 그대로 옮기기보다, 이 글들은 프로·국제 무대이 어떻게 구성되는지와 선수·순위·결과의 공식 최신 출처를 어디서 확인하는지를 설명합니다. 항상 원 출처를 보도록 안내합니다.'
        },
        es: {
