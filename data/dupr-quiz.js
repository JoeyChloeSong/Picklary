/* DUPR self-check quiz — 30-scenario POOL (10 served per attempt, adaptive).
 *
 ...
 *   ourWideL ourWideR ourScramble · oppUp oppBack oppOneBackR oppStaggerL
 * ball: { from, to, power: 'soft'|'medium'|'hard' }  (from = an opponent spot)
 * Answer ids: shots dink drop drive reset block smash speedup lob ·
 *   power soft medium hard · zones kL kM kR (their kitchen) bL bM bR (their back)
 * score.{shot,power,zone} give POINTS for a choice (missing = 0). Max = 3+3+3 = 9.
 * difficulty: 1 fundamentals · 2 intermediate · 3 advanced.
 */
module.exports = [
  // ---------- difficulty 1 ----------
  { id:'d1-third', difficulty:1, you:'ourBaseline', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:412},power:'medium'},
    incoming:'Deep return at your feet', incomingKo:'발 앞으로 떨어진 깊은 리턴',
    prompt:'Your third shot from the baseline; opponents are both at their kitchen.',
    promptKo:'베이스라인에서의 세 번째 샷. 상대 둘은 키친에 있습니다.',
    shot:{drop:3,drive:2,lob:1,reset:1}, power:{soft:3,medium:2,hard:0}, zone:{kM:3,kL:2,kR:2,bM:1},
  ...
  { id:'d1-popup', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:110,y:190},to:{x:150,y:250},power:'soft'},
    incoming:'High, attackable pop-up', incomingKo:'높이 뜬 공격 가능한 볼',
    ...
    shot:{speedup:3,smash:3,drive:2,dink:0}, power:{hard:3,medium:2,soft:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d1-feet', difficulty:1, you:'ourTransition', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:330},power:'hard'},
    incoming:'Hard drive at your feet', incomingKo:'발 앞으로 오는 강한 드라이브',
    ...
    shot:{reset:3,drop:2,block:1,dink:1,drive:0,smash:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d1-dink', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:90,y:190},to:{x:210,y:250},power:'soft'},
    incoming:'Low cross-court dink', incomingKo:'낮게 오는 크로스 딩크',
    ...
    shot:{dink:3,drop:1,reset:1,drive:0,speedup:1}, power:{soft:3,medium:1,hard:0}, zone:{kL:3,kR:3,kM:2},
  ...
  { id:'d1-oppback', difficulty:1, you:'ourUp', opp:'oppBack',
    ball:{from:{x:150,y:80},to:{x:150,y:250},power:'medium'},
    incoming:'Floaty ball, opponents deep', incomingKo:'상대가 뒤에 있고 떠서 오는 공',
    ...
    shot:{drop:3,dink:3,drive:1,reset:1}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d1-lobreach', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:280},power:'medium'},
    incoming:'Reachable lob', incomingKo:'닿을 수 있는 로브',
    ...
    shot:{smash:3,drive:2,speedup:2,reset:1,lob:1}, power:{hard:3,medium:1,soft:0}, zone:{kM:3,bM:2,kL:1,kR:1},
  ...
  { id:'d1-return', difficulty:1, you:'ourBaseline', opp:'oppOneBackR',
    ball:{from:{x:150,y:120},to:{x:150,y:412},power:'medium'},
    incoming:'Serve to receive', incomingKo:'리시브해야 하는 서브',
    prompt:'You are returning serve from the baseline; the server is still back.',
    promptKo:'베이스라인에서 서브를 리턴합니다. 서버는 아직 뒤에 있습니다.',
    shot:{drive:3,drop:1,lob:1,dink:0}, power:{medium:3,hard:2,soft:0}, zone:{bM:3,bL:2,bR:2},
    explain:'Return deep to push the server back, then move to the kitchen behind your return.',
    explainKo:'깊게 리턴해 서버를 뒤로 밀고, 리턴을 따라 키친으로 전진하세요.' },
  { id:'d1-middle', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:252},power:'soft'},
    incoming:'Dink up the middle', incomingKo:'가운데로 오는 딩크',
    prompt:'A dink comes right up the middle between you and your partner.',
    promptKo:'딩크가 당신과 파트너 사이 가운데로 옵니다.',
    shot:{dink:3,drop:1,reset:1,speedup:1,drive:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:1,kR:1},
  ...
  { id:'d1-shoulder', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:120,y:190},to:{x:150,y:255},power:'soft'},
    incoming:'Soft floaty ball, shoulder height', incomingKo:'어깨 높이로 뜨는 느린 공',
    prompt:'A soft, floaty ball arrives shoulder height at the net — attackable.',
    promptKo:'느리고 떠서 오는 공이 네트에서 어깨 높이로 옵니다 — 공격 가능.',
    shot:{speedup:3,smash:2,drive:2,dink:1}, power:{medium:3,hard:2,soft:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d1-comfort', difficulty:1, you:'ourUp', opp:'oppUp',
    ball:{from:{x:210,y:190},to:{x:90,y:252},power:'soft'},
    incoming:'Comfortable kitchen dink', incomingKo:'편안한 키친 딩크',
    prompt:'A comfortable, low dink lands in your kitchen; everyone is at the net.',
    promptKo:'편안하고 낮은 딩크가 키친에 떨어집니다. 모두 네트에 있습니다.',
    shot:{dink:3,drop:1,reset:1,speedup:0,drive:0}, power:{soft:3,medium:1,hard:0}, zone:{kL:3,kR:3,kM:2},
  ...
  // ---------- difficulty 2 ----------
  { id:'d2-thirddrive', difficulty:2, you:'ourBaseline', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:412},power:'medium'},
    incoming:'Lower, drivable return', incomingKo:'낮아서 드라이브 가능한 리턴',
    prompt:'Third shot, opponents up — but the return came in low and drivable.',
    promptKo:'세 번째 샷, 상대는 앞에 — 그런데 리턴이 낮게 와 드라이브가 가능합니다.',
    shot:{drive:3,drop:3,speedup:1,lob:0}, power:{medium:3,hard:2,soft:1}, zone:{bM:3,kM:2,bL:1,bR:1},
  ...
  { id:'d2-gap', difficulty:2, you:'ourBaseline', opp:'oppStaggerL',
    ball:{from:{x:150,y:190},to:{x:150,y:412},power:'medium'},
    incoming:'Return, middle gap open', incomingKo:'리턴, 가운데가 비어 있음',
    prompt:'Opponents have shifted and left a clear gap up the middle.',
    promptKo:'상대가 한쪽으로 쏠려 가운데가 확실히 비었습니다.',
    shot:{drive:3,drop:2,speedup:2,dink:0}, power:{medium:3,hard:2,soft:1}, zone:{kM:3,bM:2,kL:1},
  ...
  { id:'d2-wide', difficulty:2, you:'ourWideL', opp:'oppUp',
    ball:{from:{x:210,y:190},to:{x:25,y:285},power:'medium'},
    incoming:'Sharp angle, you’re stretched', incomingKo:'날카로운 각도, 몸이 늘어남',
    prompt:'A sharp angled dink pulls you wide and you are stretched and reaching.',
    promptKo:'날카로운 각도의 딩크에 코트 밖으로 끌려 나가 몸이 늘어났습니다.',
    shot:{dink:3,reset:3,drop:2,drive:0,speedup:0,smash:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kR:2,kL:1},
  ...
  { id:'d2-blockchest', difficulty:2, you:'ourUp', opp:'oppUp',
    ball:{from:{x:110,y:190},to:{x:150,y:256},power:'hard'},
    incoming:'Hard speed-up at your chest', incomingKo:'가슴으로 오는 강한 스피드업',
    prompt:'The opponent speeds one up hard at you at the net, around chest height.',
    promptKo:'상대가 네트에서 가슴 높이로 강하게 스피드업을 합니다.',
    shot:{block:3,reset:2,speedup:1,drive:1,smash:0}, power:{medium:3,soft:2,hard:1}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d2-highbh', difficulty:2, you:'ourUp', opp:'oppUp',
    ball:{from:{x:90,y:190},to:{x:120,y:250},power:'soft'},
    incoming:'Slightly high backhand dink', incomingKo:'약간 높은 백핸드 딩크',
    prompt:'The opponent leaves a slightly high dink to your backhand side.',
    promptKo:'상대가 백핸드 쪽으로 약간 높은 딩크를 줍니다.',
    shot:{speedup:3,drive:2,dink:1,block:1}, power:{medium:3,hard:1,soft:1}, zone:{kM:3,kR:2,kL:1},
  ...
  { id:'d2-knees', difficulty:2, you:'ourTransition', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:325},power:'medium'},
    incoming:'Ball back at your knees, moving up', incomingKo:'전진 중 무릎으로 오는 공',
    ...
    shot:{reset:3,drop:2,block:1,drive:0,smash:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d2-lowdrive', difficulty:2, you:'ourTransition', opp:'oppUp',
    ball:{from:{x:210,y:190},to:{x:150,y:320},power:'hard'},
    incoming:'Low drive at midcourt', incomingKo:'미드코트로 오는 낮은 드라이브',
    ...
    shot:{reset:3,block:2,drop:2,drive:0,speedup:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d2-shortlow', difficulty:2, you:'ourUp', opp:'oppUp',
    ball:{from:{x:90,y:190},to:{x:210,y:250},power:'soft'},
    incoming:'Short, low dink at a tempting angle', incomingKo:'짧고 낮지만 각이 유혹적인 딩크',
    ...
    shot:{dink:3,drop:1,reset:1,speedup:0,drive:0}, power:{soft:3,medium:1,hard:0}, zone:{kR:3,kM:2,kL:1},
  ...
  { id:'d2-deeplob', difficulty:2, you:'ourUp', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:300},power:'medium'},
    incoming:'Deep lob over your head', incomingKo:'머리 위를 넘기는 깊은 로브',
    ...
    shot:{drop:3,reset:3,lob:1,smash:0,drive:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d2-sitter', difficulty:2, you:'ourUp', opp:'oppUp',
    ball:{from:{x:120,y:190},to:{x:150,y:248},power:'soft'},
    incoming:'Partner’s block pops up to you', incomingKo:'파트너의 블록이 떠서 당신에게',
    prompt:'Opponents sped up at your partner, who blocks it back high — the sitter comes to you.',
    promptKo:'상대가 파트너에게 스피드업했고, 파트너의 블록이 높게 떠서 당신에게 옵니다(찬스볼).',
    shot:{smash:3,speedup:2,drive:2,dink:0}, power:{hard:3,medium:2,soft:0}, zone:{kM:3,kL:2,kR:2},
  ...
  // ---------- difficulty 3 ----------
  { id:'d3-atp', difficulty:3, you:'ourWideR', opp:'oppUp',
    ball:{from:{x:90,y:190},to:{x:285,y:250},power:'soft'},
    incoming:'Wide, low, short — pulls you off court', incomingKo:'넓고 낮고 짧게 — 코트 밖으로 끌어냄',
    ...
    shot:{drive:3,smash:1,dink:1,speedup:1}, power:{medium:3,hard:3,soft:0}, zone:{bR:3,bM:2,kR:1},
  ...
  { id:'d3-erne', difficulty:3, you:'ourUp', opp:'oppUp',
    ball:{from:{x:75,y:190},to:{x:70,y:250},power:'soft'},
    incoming:'Repeated dink to the same sideline', incomingKo:'같은 사이드라인으로 반복되는 딩크',
    ...
    shot:{speedup:3,smash:2,drive:2,dink:0,reset:0}, power:{hard:3,medium:2,soft:0}, zone:{kM:3,kR:2,bM:1},
  ...
  { id:'d3-hands', difficulty:3, you:'ourUp', opp:'oppUp',
    ball:{from:{x:130,y:190},to:{x:150,y:255},power:'hard'},
    incoming:'Fast hands battle, ball at chest', incomingKo:'빠른 핸즈 배틀, 가슴으로 오는 공',
    ...
    shot:{block:3,speedup:2,reset:1,drive:1,smash:0}, power:{medium:3,hard:1,soft:1}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d3-linedrive', difficulty:3, you:'ourUp', opp:'oppUp',
    ball:{from:{x:210,y:190},to:{x:210,y:255},power:'hard'},
    incoming:'Hard drive down your line', incomingKo:'라인을 따라 오는 강한 드라이브',
    prompt:'Set at the kitchen, you face a hard drive aimed right down your line.',
    promptKo:'키친에 자리 잡았는데, 라인을 따라 강한 드라이브가 옵니다.',
    shot:{block:3,reset:2,drive:0,speedup:1,smash:0}, power:{medium:3,soft:2,hard:1}, zone:{kM:3,kR:2,kL:1},
  ...
  { id:'d3-noopening', difficulty:3, you:'ourUp', opp:'oppUp',
    ball:{from:{x:90,y:190},to:{x:120,y:250},power:'soft'},
    incoming:'High backhand, but no open court', incomingKo:'높은 백핸드지만 빈 코트가 없음',
    ...
    shot:{speedup:3,dink:2,block:1,smash:1,drive:1}, power:{medium:3,hard:1,soft:1}, zone:{kM:3,kL:2,kR:1},
  ...
  { id:'d3-goodrop', difficulty:3, you:'ourUp', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:250},power:'soft'},
    incoming:'A perfect drop into your kitchen', incomingKo:'키친에 완벽히 떨어진 드롭',
    prompt:'The opponent’s third-shot drop lands perfectly low in your kitchen.',
    promptKo:'상대의 서드샷 드롭이 당신 키친에 완벽하게 낮게 떨어집니다.',
    shot:{dink:3,drop:2,reset:1,speedup:0,drive:0,smash:0}, power:{soft:3,medium:1,hard:0}, zone:{kM:3,kL:2,kR:2},
  ...
  { id:'d3-poach', difficulty:3, you:'ourUp', opp:'oppStaggerL',
    ball:{from:{x:90,y:190},to:{x:150,y:252},power:'medium'},
    incoming:'Middle ball, you’re the stronger forehand', incomingKo:'가운데 공, 당신이 더 강한 포핸드',
    ...
    shot:{speedup:3,drive:3,dink:1,block:0}, power:{medium:3,hard:2,soft:0}, zone:{kM:3,bM:2,kL:1},
  ...
  { id:'d3-deflob', difficulty:3, you:'ourScramble', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:400},power:'hard'},
    incoming:'You’re pushed back, scrambling', incomingKo:'뒤로 밀려 허둥대는 상황',
    ...
    shot:{lob:3,reset:2,drop:2,smash:0,drive:1}, power:{medium:3,soft:1,hard:1}, zone:{bM:3,bL:2,bR:2},
  ...
  { id:'d3-chestmid', difficulty:3, you:'ourTransition', opp:'oppUp',
    ball:{from:{x:150,y:190},to:{x:150,y:320},power:'medium'},
    incoming:'Controllable chest ball, moving in', incomingKo:'전진 중 다룰 수 있는 가슴 공',
    ...
    shot:{reset:3,drive:2,drop:2,speedup:1,smash:0}, power:{soft:2,medium:3,hard:0}, zone:{kM:3,bM:2,kL:1},
  ...
  { id:'d3-atp2', difficulty:3, you:'ourWideL', opp:'oppUp',
    ball:{from:{x:210,y:190},to:{x:18,y:255},power:'soft'},
    incoming:'Wide low ball — clean ATP or safe dink?', incomingKo:'넓고 낮은 공 — 깔끔한 ATP냐 안전한 딩크냐',
    ...
    shot:{drive:3,dink:2,reset:1,smash:0,speedup:1}, power:{medium:3,hard:2,soft:1}, zone:{bL:3,bM:2,kL:1},
