...
module.exports = [
  ...
  { id:'d1-return', difficulty:1, you:'ourReturn', opp:'oppBack',
    ball:{from:{x:90,y:92},to:{x:206,y:400},power:'medium'},
    ...
    shot:{drive:3,drop:1,lob:1,dink:0}, power:{medium:3,hard:2,soft:0}, zone:{bL:3,bM:3,bR:2},
