  ...
  return [
    {
      ...
      translations: {
        ko: {
          ...
          focus: ['코트 구역과 비발리존 이해', '합법적인 서브와 침착한 포인트 시작', '간단한 포핸드/백핸드로 공을 살리기', '더블스 스코어와 기본 매너 익히기'],
          skills: ['서브와 리턴 기본', '준비 자세', '투바운스 규칙', '비발리존으로 이동하기'],
    ...
    },
    {
      ...
      translations: {
        ko: {
          title: '레벨 3.0: 랠리가 되는 선수',
          subtitle: '서브, 리턴, 3구, 키친 플레이를 반복 가능한 패턴으로 만듭니다.',
          summary: '공을 넘기는 것은 가능하지만 승점 구조가 필요한 선수를 위한 단계입니다.',
    ...
    },
    {
      ...
      translations: {
        ko: {
          ...
          drills: ['3개 딩크 패턴 드릴', '공격 가능한 공 구분', '빠른 손 배틀 7점', '미들 콜 섀도 드릴'],
