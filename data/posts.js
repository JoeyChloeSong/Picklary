...
(function (root, factory) {
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "입문자가 첫 패들을 살 때 확인해야 할 무게, 그립 크기, 컨트롤 성향, 가격대 기준을 설명합니다.",
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        "title": "피클볼 대회는 어떻게 진행될까: 경기 방식과 대진표",
        "subtitle": "처음 대회에 나갈 때 알아야 할 참가 부문, 경기 방식, 체크인 흐름입니다.",
        "summary": "피클볼 대회의 레벨·연령 참가 부문, 풀 플레이, 싱글 엘리미네이션, 더블 엘리미네이션 개념을 설명합니다.",
        "body": "\n<p>첫 대회 신청 화면을 보면 레벨, 연령, 종목, 대진표 방식이 한꺼번에 보여 어렵게 느껴질 수 있습니다. 하지만 기본 구조만 알면 준비가 훨씬 쉬워집니다.</p>\n<h2 id=\"division\">참가 부문 선택</h2>\n<p>대회는 보통 레벨과 연령, 종목으로 나뉩니다. 예를 들어 남자 복식 3.0, 혼합 복식 3.5처럼 신청합니다. 너무 높은 참가 부문에 무리하게 들어가기보다 현재 안정적으로 경기할 수 있는 수준을 선택하는 것이 좋습니다.</p>\n<h2 id=\"formats\">경기 방식</h2>\n<p>풀 플레이는 같은 조의 여러 팀과 모두 경기한 뒤 순위를 정하는 방식입니다. 싱글 엘리미네이션은 한 번 지면 탈락하고, 더블 엘리미네이션은 한 번 패해도 패자 대진표에서 기회가 남는 방식입니다. 대회마다 규정이 다르므로 공지문을 확인해야 합니다.</p>\n<h2 id=\"day\">대회 당일 흐름</h2>\n<p>체크인, 코트 배정, 대기, 경기, 결과 확인 순서로 진행됩니다. 대기 시간이 길 수 있으므로 물, 간식, 여분 공, 수건, 보온 또는 냉방 용품을 준비하면 좋습니다.</p>\n<h2 id=\"mindset\">처음 참가자의 마음가짐</h2>\n<p>첫 대회의 목표는 우승보다 경험입니다. 긴장 속에서 서브와 리턴을 안정적으로 넣고, 파트너와 콜을 분명히 하는 것만으로도 큰 성과입니다.</p>",
        "keyTakeaways": [
          "참가 부문은 레벨, 연령, 종목으로 나뉩니다.",
          "대진표 방식은 대회 공지에서 반드시 확인해야 합니다.",
          "첫 대회는 결과보다 경험과 경기 운영을 배우는 자리입니다."
        ],
        "commonMistakes": [
          "실력보다 높은 참가 부문에 무리하게 신청함.",
          "대기 시간과 준비물을 고려하지 않음.",
          "파트너와 콜 약속 없이 경기함."
        ],
        "checklist": [
          "내 레벨에 맞는 참가 부문을 선택했나요?",
          "경기 방식과 시작 시간을 확인했나요?",
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "subtitle": "2.0~3.0 선수가 경기 흐름을 안정시키는 가장 빠른 방법입니다.",
    ...
    "translations": {
      "ko": {
        ...
        "faq": [
          {
            "q": "처음 가면 어떻게 끼면 되나요?",
            "a": "패들 대기 방식부터 확인하고, 주변 선수에게 간단히 물어보면 됩니다."
          },
          {
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "3.0 선수가 보통 하는 샷과 판단, 3.0과 3.5의 차이, 그리고 내가 대략 어디쯤인지 가늠하는 법."
      }
    }
  },
  {
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "3.5 선수를 가로막는 구체적 습관과, 인내·리셋·코스 선택·샷 선택을 고쳐 4.0을 여는 법."
      }
    }
  },
  {
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "2.5 선수에 대한 솔직한 설명, 이 레벨을 정의하는 일관성 격차, 그리고 3.0으로 이어지는 단계."
      }
    }
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "패들이 컨트롤 또는 파워로 기우는 이유, 각각의 장단점, 그리고 내 경기에 맞는 쪽을 고르는 법."
      }
    }
  },
  {
    ...
    "translations": {
      "ko": {
        "title": "3.5 선수를 위한 패들 고르기",
        "subtitle": "3.5에선 소프트 게임이 포인트를 결정하니 패들이 그걸 받쳐 주게 하라.",
        "summary": "3.5 선수가 패들에서 봐야 할 것 — 컨트롤·스핀·편안한 스윙 웨이트 — 와, 순수 파워를 좇으면 보통 역효과인 이유."
      }
    }
  },
  {
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "body": "\n<p>피클볼 3.0과 3.5의 차이는 자주 오해됩니다. 많은 선수가 더 빠른 공, 더 강한 서브, 더 센 드라이브가 필요하다고 생각합니다. 도움이 될 수는 있지만 진짜 차이는 판단의 질입니다. 3.5 선수는 어떤 공을 공격할 수 있는지, 어떤 공은 리셋해야 하는지, 언제 앞으로 가야 하는지, 언제 랠리를 더 어렵게 만들지 말아야 하는지를 압니다.</p>\n<h2 id=\"consistency\">약한 압박 속에서도 유지되는 일관성</h2>\n<p>3.0 선수는 협조적인 드릴에서는 좋아 보이다가 랠리 속도가 올라가면 자세가 무너질 수 있습니다. 3.5에서는 같은 기본 샷이 약한 압박 속에서도 유지됩니다. 서브는 들어가고, 리턴은 깊게 갑니다. 딩크가 완벽할 필요는 없지만 네트를 넘고 너무 높게 뜨지 않습니다. 리셋이 자동으로 되는 것은 아니지만, 단순히 막고 바라보는 것이 아니라 의도가 있습니다.</p>\n<h2 id=\"transition\">전환 구역을 의도적으로 사용하기</h2>\n<p>3.0 선수는 전환 구역을 무작정 뛰어 지나가거나 그곳에 멈춰 서는 경우가 많습니다. 3.5 선수는 코트 중간이 일하는 구역이라는 것을 압니다. 공이 낮으면 스플릿 스텝 후 리셋합니다. 공이 높으면 전진하며 압박합니다. 팀이 불안정하면 공격을 강요하지 않고 시간을 법니다. 많은 3.5 게임은 한 팀이 컨트롤을 유지하며 키친에 도달하느냐에서 결정됩니다.</p>\n<h2 id=\"attackable\">공격 가능한 공과 아닌 공</h2>\n<p>3.5의 중요한 능력은 높이를 보는 것입니다. 네트보다 낮은 공은 대부분 강하게 칠 공이 아닙니다. 네트보다 높고 몸 앞에 있는 공은 공격 가능할 수 있습니다. 많은 3.0 선수는 낮은 공을 공격하다가 띄웁니다. 많은 3.5 선수는 한 공 더 기다렸다가 유리한 각도에서만 공격합니다. 이 인내심은 화려해 보이지 않지만 포인트를 가져옵니다.</p>\n<h2 id=\"defense\">수비는 단순히 버티는 것이 아님</h2>\n<p>3.5에서는 블록과 리셋이 목적을 가집니다. 모든 스피드업을 맞받아치려 하기보다, 속도를 흡수하고 키친에 떨어뜨리거나 크로스 리셋으로 랠리의 방향을 바꿉니다. 수비는 절박한 반응이 아니라 중립으로 돌아가는 방법입니다. 그래서 부드러운 손 감각은 파워만큼 중요합니다.</p>\n<h2 id=\"doubles\">복식 규율</h2>\n<p>3.5 선수는 간격을 존중합니다. 파트너 쪽으로 과하게 침범하지 않습니다. 파트너가 바깥으로 끌려가면 중앙을 덮습니다. 좋은 스윙을 잘못된 타깃으로 보내는 것보다, 평범한 샷을 맞는 타깃으로 보내는 것이 낫다는 것을 압니다. 소통도 좋아지지만, 더 중요한 것은 포지셔닝이 덜 무작위가 된다는 점입니다.</p>\n<p>3.5에 가까워졌다면 한 게임을 녹화해 <a href=\"/ko/boards/skill-review/\">Picklary 스킬 평가</a>를 사용해 보세요. 최종 DUPR식 숫자만 보지 말고 판단 기준별로 평가를 요청하는 것이 좋습니다. 3.0과 3.5 사이의 숨은 차이는 보통 공격하지 않기로 선택한 공에서 드러납니다.</p>",
        "keyTakeaways": [
        ...
        "heroImageAlt": "피클볼 3.0과 3.5 선수의 포지셔닝, 샷 선택, 컨트롤 차이를 나란히 비교한 코트 일러스트",
  ...
  },
  {
    ...
    "translations": {
      "ko": {
        ...
        "summary": "출장·여행 중인 피클볼 선수가 도시와 우편번호, 레벨, 일정, 플레이 목적을 기준으로 지역 그룹과 연결되는 가이드입니다.",
        "body": "\n<p>피클볼은 여행 중에도 즐기기 쉬운 스포츠입니다. 완전한 팀이 필요하지 않고, 많은 도시에는 오픈플레이가 있기 때문입니다. 하지만 낯선 지역에서 맞는 게임을 찾으려면 “근처 코트 있나요?”보다 더 좋은 요청이 필요합니다. 좋은 방문 선수 소개에는 위치, 날짜, 레벨, 가능한 시간, 원하는 플레이 종류가 들어갑니다.</p>\n<h2 id=\"before\">방문 전 준비</h2>\n<p>도시와 우편번호를 함께 검색하고, 공원, 클럽, 커뮤니티 센터, 지역 그룹을 찾아보세요. 코트 주소는 어디서 플레이가 일어날 수 있는지 알려주고, 지역 운영자는 언제 어떤 레벨이 모이는지 알려줍니다. Picklary의 <a href=\"/ko/boards/friends/\">친구찾기</a>를 사용한다면 방문 선수 카테고리를 선택하고 방문 기간을 적으면 됩니다.</p>\n<h2 id=\"intro\">유용한 자기소개 쓰기</h2>\n<p>좋은 메시지는 짧지만 구체적입니다. “7월 8~10일 Chicago 60614 방문, 3.5 복식 선수, 저녁 오픈플레이나 드릴 희망”처럼 쓰면 지역 사람들이 도와주기 쉽습니다. 캐주얼 게임, 경쟁 게임, 드릴, 혼합 그룹 중 무엇을 원하는지도 적으세요. 정확한 호텔 정보는 쓰지 말고 가까운 우편번호나 동네 정도만 적으면 충분합니다.</p>\n<h2 id=\"etiquette\">지역 규칙 존중하기</h2>\n<p>모든 그룹은 자체 로테이션 방식이 있습니다. 어떤 곳은 패들랙을 쓰고, 어떤 곳은 승자 유지 방식이며, 어떤 곳은 레벨별로 나누고, 어떤 곳은 사전 등록이 필요합니다. 바로 들어가기 전에 물어보세요. 방문자라면 처음 몇 게임은 유연하게 참여하는 것이 좋습니다. 좋은 방문자는 그룹 운영을 더 쉽게 만들어 다시 초대받습니다.</p>\n<h2 id=\"safety\">안전과 개인정보</h2>\n<p>공개 코트에서 만나고, 개인 주소를 공유하지 않으며, 가능하면 공식 클럽이나 공원 채널을 이용하세요. 누군가 개인 그룹에 초대한다면 레벨, 코트 위치, 예상 인원, 게스트 환영 여부를 물어보세요. 미성년자의 경우 부모나 보호자가 소통해야 합니다.</p>\n<h2 id=\"after\">방문 후</h2>\n<p>좋은 경험이었다면 운영자에게 감사 인사를 전하고, 그 그룹을 다른 사람에게 공유하기 전 허락을 받으세요. 지역 커뮤니티는 코트 수용 인원을 조심스럽게 관리할 수 있고, 모든 세션이 공개용은 아닙니다. 존중하는 방문자가 여행 피클볼 문화를 건강하게 만듭니다.</p>\n<p>Picklary가 성장하면 방문 선수 글은 커뮤니티의 가장 유용한 기능 중 하나가 될 수 있습니다. 개인정보를 올리거나 완전한 소셜 네트워크를 기다리지 않고도 실제 게임을 찾는 가벼운 방법이기 때문입니다.</p>",
        "keyTakeaways": [
          "좋은 방문 선수 요청에는 위치, 날짜, 레벨, 플레이 목적이 들어갑니다.",
...
<p>세 가지만 알면 바로 시작할 수 있습니다: 점수·서브, 투바운스 규칙, 그리고 키친입니다. 먼저 <a href="/ko/pickleball-rules-at-a-glance/">규칙 한눈에 보기</a>를 읽고, <a href="/ko/the-kitchen-non-volley-zone-explained/">키친(비발리존) 설명</a>을 확인하세요. 복식이라면 <a href="/ko/doubles-positioning-basics/">기본 포지셔닝</a>을 더해 파트너와 한 몸처럼 움직이세요.</p>
