...
module.exports = function enrichTourBoard(board) {
  ...
  addEvent({
    ...
    sourceName:'PPA official event page', sourceUrl:source.cape, secondaryName:'PPA Championship Sunday recap', secondaryUrl:source.capeStats, resultChecked:'2026-07-22', resultNote:'Official Winners Circle, brackets, and Championship Sunday recap verified.', resultNoteKo:'공식 Winners Circle·대진표·리캡 확인 완료.',
    results:[
    ...
    resultLinks:[{label:'Official Winners Circle and brackets',labelKo:'공식 Winners Circle·대진표',url:source.cape},{label:'Championship Sunday recap',labelKo:'챔피언십 선데이 리캡',url:source.capeStats}],
    ...
    stories:[
      ...
      {kicker:'OPEN SINGLES',kickerKo:'열린 싱글',title:'Christian and Staksrud converted opportunity into titles',titleKo:'Christian과 Staksrud, 기회를 타이틀로',body:'Open draws still require discipline; both champions handled the week without assuming the bracket would solve itself.',bodyKo:'열린 드로우도 규율이 필요합니다. 두 우승자는 대진표가 스스로 해결될 것이라 생각하지 않았습니다.'}
    ],
